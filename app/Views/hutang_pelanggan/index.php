...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <h1 class="mt-3">
                Daftar Hutang Pelanggan Harian
            </h1>
                ...
                <tbody>
                    <?php foreach ($data_row as $d) : ?>
                        <tr>
                            ...
                            <td><?= $d['hutang_nama']; ?></td>
                            <td><?= $d['hutang_date']; ?></td>
                            <td><?= $d['hutang_nominal'] / 1000; ?></td>
                            <!-- <td><//?= strtolower($d['omzet_catatan']); ?></td> -->
                            <td><?= $d['hutang_alamat']; ?></td>
                            <td><?= $d['hutang_telp']; ?></td>
                            <td><?= $d['hutang_islunas']; ?></td>
                            <td><?= $d['hutang_catatan']; ?></td>
                            <td>
                                <form action="/hutang_pelanggan/edit/<?= $d['hutang_id']; ?>" method="get" class="d-inline">
                                    <?= csrf_field(); ?>
                            ...
                            <td>
                                <form action="/hutang_pelanggan/<?= $d['hutang_id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
