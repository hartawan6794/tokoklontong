...
<div class="container">
    <div class="row">
        <div class="col">
            <h2 class="my-3">Edit Barang Habis</h2>
            ...
            ?>
            <form action="/barang_habis/update/<?= $dataBarangHabisDiedit['habis_id']; ?>" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?= ($validation->hasError('habis_namabarang')) ? 'is-invalid' : ''; ?>" id="habis_namabarang" name="habis_namabarang" autofocus value="<?= (old('habis_namabarang')) ? old('habis_namabarang') : $dataBarangHabisDiedit['habis_namabarang'] ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?= ($validation->hasError('input_habis_date')) ? 'is-invalid' : ''; ?>" id="input_habis_date" name="input_habis_date" autofocus value="<?= (old('input_habis_date')) ? old('input_habis_date') : $dataBarangHabisDiedit['habis_date'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control <?= ($validation->hasError('habis_catatan')) ? 'is-invalid' : ''; ?>" name="habis_catatan" rows="2" value="" id="habis_catatan"><?= (old('habis_catatan')) ? old('habis_catatan') : $dataBarangHabisDiedit['habis_catatan'] ?></textarea>
                        <div class="invalid-feedback">
