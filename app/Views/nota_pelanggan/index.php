...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="/barang_habis/create" class="btn btn-primary mt-3">Tambah Barang Habis</a>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Habis ID</th>
                        <th scope="col">Nama Barang</th>
                        <th scope="col">Status Pembelian</th>
                        <th scope="col">Habis Date</th>
                ...
                <tbody>
                    <?php foreach ($data_row as $d) : ?>
                        <tr>
                            <td><?= $d['habis_id']; ?></td>
                            <td><?= $d['habis_namabarang']; ?></td>
                            <td><?= $d['habis_sudahdibeli']; ?></td>
                            <td><?= $d['habis_date']; ?></td>
                            <td><?= $d['habis_catatan']; ?></td>

                            <td>
                                <form action="/barang_habis/edit/<?= $d['habis_id']; ?>" method="get" class="d-inline">
                                    <?= csrf_field(); ?>
                            ...
                            <td>
                                <form action="/barang_habis/<?= $d['habis_id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
